...
nt_explanation: "Hebrews calls Jesus an eternal high priest in Melchizedek's order. Christians see the priest-king in Genesis as the pattern behind that claim."
nt_connections: [{"reference":"Hebrews 6:20","social":true,"social_text":null,"text":"where Jesus our forerunner has entered on our behalf. He has become a high priest forever in the order of Melchizedek.","url":"https://ebible.org/engbsb/HEB06.htm#V20"}]
